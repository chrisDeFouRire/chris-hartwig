/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ad2f187e69d34bfccebb081a0cd69a86)
// Runtime types generated with workerd@1.20251210.0 2025-11-26 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
	}
	interface Env {
		CANONICAL_URL: "https://chris-hartwig.com" | "http://localhost:4321";
		POSTMARK_API_TOKEN: string;
		DB: D1Database;
		ASSETS: Fetcher;
		SEND_NEWSLETTER_WORKFLOW: Workflow<Parameters<import("./src/worker").SendNewsletterIssue['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CANONICAL_URL" | "POSTMARK_API_TOKEN">> {}
}
